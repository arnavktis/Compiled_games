...
runt_1 = 0
runt_2 = 0
i = int(input("Enter which game do you wanna play\n1: 2v2 Space War game\n2:Alien Buster\n3:Warrior run\nGame Number: "))

if (i==1):
    runt_1 = 1
    if (runt_1 == 1):
        print("WELCOME TO SPACE WAR")
...
if(i == 2):
    ...
    #background
    background = pygame.image.load("/Users/arnavkhanna/Desktop/final_game/COMPILED/background1.png")
    background2 = pygame.image.load("/Users/arnavkhanna/Desktop/final_game/COMPILED/background21.png")
    #Title and Icon
    arrow = pygame.image.load("/Users/arnavkhanna/Desktop/final_game/COMPILED/up-arrow.png")
